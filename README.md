...
- Post-call summary generated by Gemini (`gemini-3-flash-preview`)
...
| AI — Live Voice | Google Gemini `gemini-3.1-flash-live-preview` |
...
sequenceDiagram
    ...
    S->>G: Request Summary (gemini-3-flash-preview)
    G-->>S: JSON Summary
...
| Model ID | Where used |
|----------|-----------|
| `gemini-3.1-flash-live-preview` | Real-time voice call — audio in, audio out, live transcription |
| `gemini-3-flash-preview` | Post-call summary, sentiment, ROI projection, knowledge base processing |
...
- Some API keys have restricted access to `gemini-3.1-flash-live-preview`
